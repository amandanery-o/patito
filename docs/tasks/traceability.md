...
| REQ-014–022, 045–048, 057, 067–071  | F004, F009       | TASK-021–024, 042–057  | P1 e P2 publicadas com revisão auditável; unitários e E2E de Ciências e Inglês P1 | Ciências e Inglês P1 publicadas; próximas matérias ordenadas no roteiro editorial |
...
| REQ-036–039                         | F005, F009       | TASK-025–028, 047, 058 | Importador, manifesto v2, correção SQL e testes de datas                          | Correção de 17/09 publicada; 27 eventos únicos confirmados no Supabase            |
...
| REQ-007, 019, 049, 058, 061         | F008             | TASK-038–041           | Sanitização, UI e falhas do GitHub                                                | Função publicada; token restrito do GitHub ainda pendente                         |
...
As ações externas restantes e suas evidências de conclusão estão consolidadas em `docs/operations/go-live-checklist.md`.
