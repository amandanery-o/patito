...
export default function BottomNav({ activeView, onHome, onHomework, onSchedule, onCalendar, onLeaderboard }) {
  return (
...
function NavTab({ active, onClick, icon, label, useCustomIcon = false }) {
  return (
    <button
      onClick={onClick}
      aria-label={label}
