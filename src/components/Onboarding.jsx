...
export default function Onboarding({ onComplete }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white flex flex-col items-center justify-center px-6 py-12 animate-slide-up">
      ...
      <p className="text-gray-500 text-base sm:text-xl mt-2 text-center">Seu companheiro de estudos do 4º ano</p>

      <form onSubmit={handleSubmit} className="w-full max-w-xs sm:max-w-sm md:max-w-md mt-6 space-y-4">
        <div>
          <label className="block text-sm font-bold text-gray-600 mb-1.5">Qual é o seu nome?</label>
          <input
            autoFocus
            type="text"
            value={name}
