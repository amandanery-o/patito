...
const baseProps = {
  items: [], loading: false, saving: false, error: '',
  onCreate: vi.fn(), onUpdate: vi.fn(), onRemove: vi.fn(), onBack: vi.fn(),
}
...
describe('HomeworkView', () => {
  ...
  it('cria um dever com descrição, páginas e data', async () => {
    ...
    fireEvent.click(screen.getByText('+ Novo'))
    fireEvent.change(screen.getByPlaceholderText('Ex.: Exercícios de Matemática'), { target: { value: 'Ler Ciências' } })
    ...
    await waitFor(() => expect(onCreate).toHaveBeenCalledWith({
      description: 'Ler Ciências', pages: '30-32', dueDate: '2026-08-25',
    }))
  })
