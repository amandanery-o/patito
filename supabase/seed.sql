...
begin;
insert into public.school_events (external_id, subject_id, type, date, end_date, time, weight, content, notes, source_file, source_version)
values
  ('t43-2026-s2-20260831-trabalho-geografia', 'geografia', 'trabalho', '2026-08-31', null, null, 2, 'Setores da economia — capítulo 6', 'Trabalho T2', 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20260903-trabalho-historia', 'historia', 'trabalho', '2026-09-03', null, null, 2, 'As formas de comunicação — capítulo 8', 'Trabalho T2', 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ...
  ('t43-2026-s2-20261112-prova-portugues', 'portugues', 'prova', '2026-11-12', null, null, 3, 'Leitura e interpretação; concordância verbal (p. 166); pronomes possessivos (p. 180); IZAR/ISAR (p. 182); porquês (p. 214); H inicial (p. 216)', 'Prova P2', 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261113-prova-ingles', 'ingles', 'prova', '2026-11-13', null, null, 3, 'Unidades 7 e 8', 'Prova P2', 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261116-prova-geografia', 'geografia', 'prova', '2026-11-16', null, null, 3, 'Características da população brasileira e fluxos migratórios — capítulos 11 e 12', 'Prova P2', 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261118-prova-ciencias', 'ciencias', 'prova', '2026-11-18', null, null, 3, 'Caminhos da matéria e da energia; os astros e o tempo — capítulos 10 e 11', 'Prova P2', 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261119-prova-historia', 'historia', 'prova', '2026-11-19', null, null, 3, 'Migrações dentro do Brasil e a sociedade brasileira atual — capítulos 11 e 12', 'Prova P2', 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261130-recuperacao-geografia', 'geografia', 'recuperacao', '2026-11-30', null, null, 5, 'Capítulos 7, 8, 11 e 12', null, 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261201-recuperacao-matematica', 'matematica', 'recuperacao', '2026-12-01', null, null, 5, 'Capítulos 5, 6, 7, 9, 10 e 11', null, 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261202-recuperacao-ciencias', 'ciencias', 'recuperacao', '2026-12-02', null, null, 5, 'Capítulos 8, 9, 10 e 11', null, 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261203-recuperacao-historia', 'historia', 'recuperacao', '2026-12-03', null, null, 5, 'Capítulos 9, 10, 11 e 12', null, 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261204-recuperacao-ingles', 'ingles', 'recuperacao', '2026-12-04', null, null, 5, 'Unidades 5, 6, 7 e 8', null, 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1'),
  ('t43-2026-s2-20261207-recuperacao-portugues', 'portugues', 'recuperacao', '2026-12-07', null, null, 5, 'Conteúdos combinados das provas P1 e P2', null, 'PDF_2026_08_17_15_16_08.pdf', 'turma-43-2026-s2-v1')
